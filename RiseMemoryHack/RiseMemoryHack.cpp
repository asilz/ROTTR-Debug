...
struct UnitLightGroup {
    char* lightgroupID;
    bool defaultGroupEnabled;
    bool associateWithStreamLayer : 1;
    bool currentGroupEnabled : 1;
    signed char __bitfieldpadding2 : 6;
    float defaultGroupIntensityScale;
    float defaultGroupRangeScale;
    int streamLayerMode;
    unsigned char numStreamLayers;
    unsigned char streamLayers[8];
    float currentGroupIntensityScale;
    float currentGroupRangeScale;
    float currentGroupFader;
    int currentStreamLayersEnabled;
};
...
struct LightInstance {
    ...
    struct ISceneLight* m_pSceneLight;
